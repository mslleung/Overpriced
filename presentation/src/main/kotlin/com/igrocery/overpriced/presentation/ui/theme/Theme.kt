package com.igrocery.overpriced.presentation.ui.theme
...
private val ExtendedDarkColorPalette = ExtendedColors(
    shimmerBase = Color.White,
    shimmer = Color.White
)

private val ExtendedLightColorPalette = ExtendedColors(
    shimmerBase = Color.White,
    shimmer = Color.White
)
...
fun AppTheme(
    ...
    // TODO user should be able to choose
...
//            shapes = Shapes, coming soon in M3
            content = content
        )
    }
}
